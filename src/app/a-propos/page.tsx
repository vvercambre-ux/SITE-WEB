      ...
      <section className="bg-[#F5F0EB] py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              <p className="text-xs tracking-[0.3em] uppercase text-[#C8924A] mb-4">Notre histoire</p>
              <h1 className="font-display text-4xl lg:text-5xl font-semibold leading-tight mb-6">
                L&apos;élégance<br />
                <span className="italic text-[#C8924A]">accessible.</span>
              </h1>
      ...
      <section className="py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <p className="text-xs tracking-[0.3em] uppercase text-[#C8924A] mb-3">Nos valeurs</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
            <div className="text-center">
              <div className="w-16 h-16 mx-auto mb-6 bg-[#F5F0EB] flex items-center justify-center">
                <span className="font-display text-2xl text-[#C8924A]">01</span>
              </div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 mx-auto mb-6 bg-[#F5F0EB] flex items-center justify-center">
                <span className="font-display text-2xl text-[#C8924A]">02</span>
              </div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 mx-auto mb-6 bg-[#F5F0EB] flex items-center justify-center">
                <span className="font-display text-2xl text-[#C8924A]">03</span>
              </div>
      ...
      <section className="py-20 lg:py-24 bg-[#0A0A0A] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            <div>
              <p className="font-display text-4xl lg:text-5xl text-[#C8924A] mb-2">15K+</p>
              <p className="text-xs tracking-widest uppercase text-gray-400">Clientes satisfaites</p>
            </div>
            <div>
              <p className="font-display text-4xl lg:text-5xl text-[#C8924A] mb-2">4.8</p>
              <p className="text-xs tracking-widest uppercase text-gray-400">Note moyenne</p>
            </div>
            <div>
              <p className="font-display text-4xl lg:text-5xl text-[#C8924A] mb-2">200+</p>
              <p className="text-xs tracking-widest uppercase text-gray-400">Pièces créées</p>
            </div>
            <div>
              <p className="font-display text-4xl lg:text-5xl text-[#C8924A] mb-2">12</p>
